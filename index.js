...
const dispatch = (action) => { // it needs to receive an action will tell dispacth the specific action that occured inside our application
...
function todos(state = [], action) { // if the state is undefined set it to an empty array 
